    ...
    <section className="max-w-7x1 max-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create imagenative and visually stunning images through DALL-E AI and share them with the community
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3x1" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have created through the image you want, you can share it with others in the community
          </p>
